   ...
   static String decimal_to_hexa(int decimal) {
    ...
    public static String convertString(String str){
		...
		for(char ch:str.toCharArray()){
			switch (ch){
				case '0':str1.append("zero ");
				break;
				case '1':str1.append("one ");
				break;
				case '2':str1.append("two ");
				break;
				case '3':str1.append("three ");
				break;
				case '4':str1.append("four ");
				break;
				case '5':str1.append("five ");
				break;
				case '6':str1.append("six ");
				break;
				case '7':str1.append("seven ");
				break;
				case '8':str1.append("eight ");
				break;
				case '9':str1.append("nine ");
				break;
			}
		}
